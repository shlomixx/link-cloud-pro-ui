...
import { Search, Plus, Grid, List, Moon, Sun, Maximize2, Minimize2, Zap, Filter, Settings, Download, Upload, Eye, EyeOff, Keyboard, Heart, Clock, TrendingUp, ArrowUpDown, Copy, Share2, Shuffle } from 'lucide-react';
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button size="sm" variant="outline" className={`h-9 transition-all duration-300 hover:scale-105 ${
                    ...
                    {viewMode === 'dense' && <Zap className="w-4 h-4" />}
                ...
                <DropdownMenuContent className={`z-50 ${
                  ...
                  <DropdownMenuItem onClick={() => onViewModeChange('dense')}>
